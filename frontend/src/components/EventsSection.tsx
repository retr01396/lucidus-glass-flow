  ...
  return (
    ...
    >
      <div className="relative bg-black/40 backdrop-blur-xl border-2 border-white/10 rounded-3xl p-6 md:p-10 shadow-[0_0_60px_rgba(255,100,0,0.15)]">
        ...
        <div className="relative z-10 overflow-hidden bg-black/60 backdrop-blur-xl border-2 border-cyan-500/40 rounded-2xl p-5 mb-8 max-w-4xl mx-auto shadow-[0_0_50px_rgba(0,200,255,0.3)]">
          ...
          <div className="absolute top-2 right-2 text-cyan-400/30">
            <PartyPopper className="w-10 h-10 md:w-12 md:h-12" style={{ animation: 'bounce 2s infinite' }} />
          </div>
          <div className="absolute bottom-2 left-2 text-orange-400/30">
            <PartyPopper className="w-8 h-8 md:w-10 md:h-10" style={{ animation: 'bounce 2.5s infinite', animationDelay: '0.5s' }} />
          </div>
          
          <div className="relative z-10 flex items-start gap-3 md:gap-4">
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-cyan-500/30 to-purple-500/30 border-2 border-cyan-400/50 flex items-center justify-center flex-shrink-0 animate-pulse">
              <PartyPopper className="w-6 h-6 md:w-7 md:h-7 text-cyan-400" />
            </div>
            <div className="flex-1">
              <h3 className="text-xl md:text-2xl font-display font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-400 to-orange-400 mb-2" style={{
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-2 md:px-3 py-1 bg-cyan-500/20 border border-cyan-400/40 rounded-full text-cyan-300 text-[10px] md:text-xs font-semibold">
                  Epic Entertainment
                </span>
                <span className="px-2 md:px-3 py-1 bg-purple-500/20 border border-purple-400/40 rounded-full text-purple-300 text-[10px] md:text-xs font-semibold">
                  Creative Vibes
                </span>
                <span className="px-2 md:px-3 py-1 bg-orange-500/20 border border-orange-400/40 rounded-full text-orange-300 text-[10px] md:text-xs font-semibold">
                  Unforgettable Fun
                </span>
              </div>
            </div>
